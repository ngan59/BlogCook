            ...
            <div class="row">
                ...
                <div class="col-lg-7" style="padding-bottom:120px">
                    <form action="{{ route('admin.dish.update', $dish->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="id_category">
                                @foreach ($categories as $category)
                                    ...
                                    <option value="{{ $category->id }}" @if ($dish->id_category == $category->id) selected @endif>
                        ...
                        <div class="form-group">
                            <label>Tiêu đề</label>
                            <input class="form-control" name="title" value="{{$dish->title}}" id="title" onkeyup="ChangeToSlug()" placeholder="Bạn hãy nhập tiêu đề công thức" />
                        </div>
                        <div class="form-group">
                            <label>Tóm tắt</label>
                        ...
                        <button type="reset" class="btn btn-default"> <a href="{{ route('admin.dish.index')}}">Quay lại </a></button>
                    </form>
                </div>
            </div>
            <!-- /.row -->  
