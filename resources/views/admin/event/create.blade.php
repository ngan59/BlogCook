            ...
            <div class="col-lg-7" style="padding-bottom:120px">
                <form action="{{ route('admin.event.store') }}" method="POST" enctype="multipart/form-data" >
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="location" value="{{ old('location') }}" placeholder="Nhập địa điểm sự kiện..." required />
                    </div>
                    <div class="form-group">
                        <label>Slug</label>
                    ...
                    <button type="reset" class="btn btn-default"><a href="{{ route('admin.event.index') }}">Hủy bỏ</a></button>
                </form>
            </div>
        </div>
        <!-- /.row -->
