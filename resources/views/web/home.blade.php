                ...
                <div class="carousel-inner">
                    @foreach ($slides as $key => $slide)
                        <div class="carousel-item @if ($key == 0) active @endif">
                            <img src="{{ asset('/image/slide/' . $slide->image) }}" class="d-block w-100 custom-image" alt="Slide Image">
                ...
                <div class="col-lg-9">
                    <div class="page-wrapper">
                        <div class="blog-top clearfix">
                            <h4 class="pull-left">Công thức gần đây <a href="#"><i class="fa fa-cutlery food fa-spin"></i></a></h4>
                        </div><!-- end blog-top -->
                        @foreach ($new as $dish)
                                ...
                                <div class="blog-box row">
                                    <div class="col-md-4">
                                        <div class="post-media">
                                            <a href="{{ route('web.dish', $dish->slug) }}" title=""><img src="{{ $dish->imageUrl() }}" alt="" class="img-fluid">
                                    ...
                                    <div class="blog-meta big-meta col-md-8">
                                        <h4 style="margin-left: 0px !important; padding: 12px 0px !important;">
                                            <a href="{{ route('web.dish', $dish->slug) }}" title="">{{ $dish->title }}</a></h4>
                        ...
                        <div class="widget">
                            <form class="input-group custom-search-form" method="get" action="{{ route('web.search') }}">
                                ...
                                <span class="input-group-btn">
                                    <button type="submit" class="btn btn-default" style="border-radius: 0 5px 5px 0"><i class="fa fa-search"></i></button>
                                </span>
                            </form>
                        </div><!-- end widget -->
